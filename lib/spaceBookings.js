...
// max_seats_per_booking, allow_nonresident_guests }.
//
...
export async function promoteSpaceBookingToEvent(db, bookingId, actorId, isAdmin, fields) {
  ...
  const { data: event, error: insertErr } = await db
    ...
    .insert({
      ...
      allow_nonresident_guests: !!fields.allow_nonresident_guests,
      has_bus: !!fields.has_bus,
      bus_max_seats: fields.has_bus && fields.bus_max_seats != null && fields.bus_max_seats !== ''
        ? Number(fields.bus_max_seats) : null,
    })
    .select('id')
    .single()
