...
//    `anonymous` flag on a survey only controls what the results API
//    exposes to a non-Coordinator viewer (app/api/surveys/[id]/results),
//    application-level, not a database-level guarantee. See
//    100_survey_responses.sql's ANONYMITY note for the full design
//    rationale and why this is deliberate, not a shortcut.
//
