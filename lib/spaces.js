...
//   * UPDATE (Iain, 2026-08-04): some locations are "Request Only" --
//     bookable by Admin directly (trusted, gets a reminder to validate with
//     Ingenia) or by an individual resident who self-declares Ingenia
//     sign-off. This is a booking-time approval gate, not space
//     administration, so it doesn't reopen the "no per-space owners" line
//     above. See lib/spaceBookings.js's validateIngeniaConfirmation() and
//     notifyRequestOnlySpace().
//
