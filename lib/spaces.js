...
//   * Space administration is admin-only. No per-space owners.
//   * UPDATE (Iain, 2026-08-04): some locations are "Request Only". An Admin
//     creating a community EVENT against one (Movies/Social/Clubs) is
//     trusted -- no checkbox, gets a reminder to validate with Ingenia
//     instead. Personal Space Booking is different: it's for personal use
//     regardless of who's using it, so EVERY booker -- admin or not --
//     must self-declare Ingenia sign-off before it's accepted. This is a
//     booking-time approval gate, not space administration, so it doesn't
//     reopen the "no per-space owners" line above. See
//     lib/spaceBookings.js's validateIngeniaConfirmation() and
