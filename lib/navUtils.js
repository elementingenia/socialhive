...
export function getActiveHub(pathname) {
  ...
  if (pathname === "/happenings-news" || pathname.startsWith("/happenings-news/")) return "happenings_news"
  return null
}
...
export const HUB_COLOURS = {
  ...
  happenings_news: "var(--happenings-news)",
}
...
export const PAGE_TITLES = {
  ...
  "/committee/attachment":     "Attachment",
  "/happenings-news":          "Happenings News",
  "/happenings-news/manage":   "Manage Happenings News",
}
