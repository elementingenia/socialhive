...
export function clubCaps(club) {
  return {
    ...
    // Paid events are always available to the event creator/editor, same as
    // Social Hive and Special Events -- no club-level capability gate, so
    // there's no hasCost flag here (Iain, 2026-09-08).
